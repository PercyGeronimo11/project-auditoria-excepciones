...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <form action="
                            {{ route('tareacampo.store') }}" method="POST"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="input-group mb-3 ">
                        <select class="form-select" aria-label="Default select example" id="fourthSelect"
                            name="tipoValidar">
                ...
                <div class=" row mb-3 condiciones d-flex">
                    ...
                    <div class="input-group mb-3 ">
                        ...
                        {{-- <input type="text" class="form-control" aria-label="Text input with dropdown button"  name="condicion_text"> --}}
                        <input type="text" class="form-control" aria-label="Text input with dropdown button"
                            name="condicion_text[0]">
                        {{-- <input type="text" class="form-control" aria-label="Text input with dropdown button" name="condicion_text"> --}}
                        <button type="button" class="btn btn-primary add-condition-btn" id="boton-ad"
