...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown disabled">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>Scripts</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa  fa-pencil"></i><a href="{{ route('query.form') }}">Consultas</a></li>
                            <li><i class="menu-icon fa fa-tasks"></i><a href="{{route('consultas.listar')}}">Lista de consultas</a></li>
                        </ul>
                    </li> 
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a id="logoutLink" class="nav-link" href="#"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
    ...
    var logoutButton = document.getElementById('logoutForm');
    logoutButton.style.display = 'none';

    // Manejar el evento de hacer clic en el enlace de cierre de sesión
    var logoutLink = document.getElementById('logoutLink');
    logoutLink.addEventListener('click', function (event) {
        event.preventDefault(); // Prevenir la acción predeterminada del enlace
        logoutButton.submit(); // Enviar el formulario de cierre de sesión
    });
});
